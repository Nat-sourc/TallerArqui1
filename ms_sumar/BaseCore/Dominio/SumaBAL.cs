...
{
    public class SumaBAL<T> : ABussinesBase<T> where T: Suma
    {
        SumaRepository<T> repositorio;
        public SumaBAL(ILogger<SumaBAL<T>> _logger, SumaRepository<T> _repositorio)
        {
        ...
        {
            entity.resultado = entity.sumando1 + entity.sumando2;
